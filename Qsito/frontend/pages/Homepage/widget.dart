...
class _HomePageWidgetState extends State<HomePageWidget>
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<ApiCallResponse>(
      future: MorallisWebGroup.getBalanceCall.call(
        walletAddress: ' 0x6BfB89D8eEE704b83D6ff528151c7C683058435e',
        chain: 'sepolia',
      ...
      builder: (context, snapshot) {
        ...
        final homePageGetBalanceResponse = snapshot.data!;
                                    ...
                                    child: Padding(
                                      ...
                                      child: Text(
                                        valueOrDefault<String>(
                                          BalanceStruct.maybeFromMap(
                                                  homePageGetBalanceResponse
                                                      .jsonBody)
                                              ?.balance,
                                          '0',
                                        ),
                                                      ...
                                                      Expanded(
                                                        child: Padding(
                                                          ...
                                                          child: FFButtonWidget(
                                                            onPressed:
                                                                () async {
                                                              _model.resultRegistrar =
                                                                  await actions
                                                                      .registrarNota(
                                                                context,
                                                                0,
                                                                '5775fd021c280c30dd392009f451f82287c1fa791aa4c8001449c009e699162d',
                                                                '0x50874Fcc8A597c48783d69B5945934C3f292bE80',
